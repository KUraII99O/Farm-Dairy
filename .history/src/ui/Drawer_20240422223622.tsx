...
import EditStallForm from "../component/ManageStall/Form";
    ...
    >
      ...
      >
        <article className="relative w-screen max-w-lg pb-10 flex flex-col space-y-6 overflow-y-scroll h-full">
          ...
          {/* Replace this section with EditStallForm */}
          <EditStallForm stall={null} onSubmit={handleFormSubmit} onClose={() => setIsOpen(false)} />
        </article>
      </section>
      <section
