...
const EditStaff = () => {
  ...
  useEffect(() => {
    if (isEditMode && staff.length > 0) {
      ...
      if (selectedStaff) {
        // Map the selected staff data to match the form fields
        const formDataToUpdate = {
          ...
          permanentAddress: selectedStaff.permanentAddress || "",
          nid: selectedStaff.nid || "",
          image: selectedStaff.image || "", // Assuming image path is included in staff data
          userType: selectedStaff.userType || "",
          presentAddress: selectedStaff.presentAddress || "",
          basicSalary: selectedStaff.basicSalary || "",
          grossSalary: selectedStaff.grossSalary || "",
          resignDate: selectedStaff.resignDate || "",
        };
