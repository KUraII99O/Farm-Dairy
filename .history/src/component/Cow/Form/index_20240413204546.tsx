...
const EditCowForm = () => {
  ...
  const [selectedImage, setSelectedCow] = useState<string | null>(null); // State to store selected image path
  ...
  const handleFileChange = async (e) => {
    ...
    try {
      ...
      setFormData({
        ...formData,
        image: blob, // Store blob URL for preview
      });
    } catch (error) {
      console.error("Fetch error:", error);
      // Handle error if fetching blob data fails
    }
  };
