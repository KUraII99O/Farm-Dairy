...
export const TranslationProvider: React.FC = ({ children }) => {
  ...
  const translations = {
    en: {
      ...
      animalpregnancydetails :"nimal Pregnancy Details",
      pregnancytype  :"Vaccine Status",
      sementype  :"Vaccine Status",
      semenpushdate  :"Vaccine Status",
      pregnancystartdate  :"Vaccine Status",
      semencost  :"Vaccine Status",
      othercost  :"Vaccine Status",
      approximatedeliverydate  :"Vaccine Status",
      addpregnancy  :"Vaccine Status",
    },
    fr: {
