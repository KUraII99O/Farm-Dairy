        ...
        <div className="flex items-center space-x-4">
          <div className="relative flex items-center">
            <Popover
              ...
              className={`absolute ${isRTL ? "right-0" : "left-0"} top-full mt-2 w-32 sm:w-48 bg-white rounded-lg shadow-lg`}
              style={{
                [isRTL ? "right" : "left"]: isRTL ? "-100%" : "0",
                [isRTL ? "left" : "right"]: isRTL ? "0" : "-100%",
              }}
            >
