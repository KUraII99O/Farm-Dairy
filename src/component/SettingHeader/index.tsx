...
const SettingHeader: React.FC = () => {
    ...
    const getLinkStyles = (pathname: string) => {
      ...
      return `inline-flex items-center justify-center p-4 border-b-2 ${
        isActiveLink
          ? "border-b-2 text-lime-500 text-lime-500 dark:border-lime-500 dark:text-lime-500"
          : "border-transparent hover:text-gray-600 hover:text-lime-500 dark:hover:text-gray-300 group"
      } rounded-t-lg`;
    };
