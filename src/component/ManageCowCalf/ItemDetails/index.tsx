          ...
          <div className="fixed inset-0  z-50 flex justify-end ">
            ...
            <tbody>
              <tr>
                ...
                <td className="border border-gray-300 px-3 py-2">{calf.informations.stallNumber}</td>
              </tr>
              <tr>
                <td className="border border-gray-300 px-3 py-2 font-semibold">{translate("dateofbirth")}:</td>
                <td className="border border-gray-300 px-3 py-2">{calf.informations.dateOfBirth}</td>
              </tr>
              <tr>
                <td className="border border-gray-300 px-3 py-2 font-semibold">{translate("animalage")}:</td>
                <td className="border border-gray-300 px-3 py-2">{calf.informations.animalAgeDays}</td>
              </tr>
              <tr>
                <td className="border border-gray-300 px-3 py-2 font-semibold">{translate("weight")}:</td>
                <td className="border border-gray-300 px-3 py-2">{calf.informations.weight}</td>
              </tr>
              <tr>
                <td className="border border-gray-300 px-3 py-2 font-semibold">{translate("height")}:</td>
                <td className="border border-gray-300 px-3 py-2">{calf.informations.height}</td>
              </tr>
              <tr>
                <td className="border border-gray-300 px-3 py-2 font-semibold">{translate("color")}:</td>
                <td className="border border-gray-300 px-3 py-2">{calf.informations.color}</td>
              </tr>
              
              
              <tr>
                <td className="border border-gray-300 px-3 py-2 font-semibold">{translate("buyfrom")}:</td>
                <td className="border border-gray-300 px-3 py-2">{calf.informations.buyFrom}</td>
              </tr>
              <tr>
                <td className="border border-gray-300 px-3 py-2 font-semibold">{translate("prevVaccineDone")}:</td>
                <td className="border border-gray-300 px-3 py-2">{calf.informations.prevVaccineDone}</td>
              </tr>
              <tr>
                <td className="border border-gray-300 px-3 py-2 font-semibold">{translate("note")}:</td>
                <td className="border border-gray-300 px-3 py-2">{calf.informations.note}</td>
              </tr>
              <tr>
