...
const Pricing = () => {
  return (
    <div>
      <div className="max-w-md mx-auto mb-14 text-center pt-6">
      ...
      <div className="space-y-5 px-8 py-12">
        <div className="container flex space-x-2">
          ...
          <button className="text-secondary font-semibold text-base">
            (2 months free)
          </button>
        </div>
                ...
                <div className="flex flex-col flex-1 justify-between h-full space-y-5">
                  <div className="flex justify-between flex-col">
                    ...
                    <div className="pt-5 text-gray-500 font-medium text-base space-y-1">
                      <div className="flex items-center align-bottom">
                        <span className="pt-1.5">DTN</span>
                  ...
                  <div className="pt-2">
                    <a
                      ...
                      type="button"
                      target="_blank"
                      className="appearance-none inline-flex hover:shadow-2xl transition-all duration-300 hover:scale-105 items-center group space-x-2.5 bg-primary text-white py-4 px-5 rounded-2xl cursor-pointer"
                    >
